...
$(document).ready(function(){
    ...
    */
    var curip = $('#curip').text();
    // if ( !curip )
        // return false;

    var ipk  = 'f66827cd4f63e932c11db66aacc0c2a2';

    $.ajax({
        dataType: 'jsonp',
        crossDomain : true,
        url: '//api.ipstack.com/'+curip+'?access_key='+ipk
    })
    .done(function(geoData){
        ...
        $('.psc-city').html(geoData.city);
        $('.psc-area-code').html(geoData.zip);
        $('.psc-lat').html(geoData.latitude);
        $('.psc-long').html(geoData.longitude);
        // https://maps.googleapis.com/maps/api/staticmap?center=-22.8305,-43.2192&zoom=14&size=640x360&maptype=roadmap&key=AIzaSyA8bG10ivNGO9j80OPbEhrbYSf39T7-wVQ&markers=-22.82619,-43.24345&markers=-22.83275,-43.2271&markers=-22.83234,-43.23672&markers=-22.82194,-43.21077&markers=-22.82684,-43.1977&markers=-22.82977,-43.2098&markers=-22.83933,-43.2127&markers=-22.82869,-43.21525&markers=-22.83655,-43.22922&markers=-22.82563,-43.20072&markers=-22.82208,-43.20155&markers=-22.83505,-43.21375&markers=-22.83488,-43.2419&markers=-22.83349,-43.23187&markers=-22.83528,-43.23807&markers=-22.82762,-43.22062&markers=-22.8357,-43.21255&markers=-22.82519,-43.20497&markers=-22.83494,-43.21137&markers=-22.83616,-43.19685&markers=-22.8316,-43.2261&markers=-22.82734,-43.22005&markers=-22.83522,-43.23012&markers=-22.83253,-43.23507&markers=-22.83411,-43.2274&markers=-22.83728,-43.23312&markers=-22.83657,-43.20207&markers=-22.84042,-43.243&markers=-22.83113,-43.20022&markers=-22.84018,-43.22377
        mapImg = 'https://maps.googleapis.com/maps/api/staticmap?center='+
                 geoData.latitude+','+geoData.longitude+
                 '&zoom=8&size=640x640&sensor=true&scale=2&maptype=roadmap&key='+mapk;//+mapi;
        $('img.map-bg').attr('src',mapImg);
        ...
        if($('.match-map').length > 0){
            $('.match-map').each(function(){
                ...
                baseImg += '&zoom=14&size=640x360&maptype=roadmap';// &key=' + mapk; // + mapi;
                for(i = 0; i < numMarkers; i++){
                    marker = randomLatLong(geoData);
                    baseImg += '&markers='+marker.latitude+','+marker.longitude;
                }
                $this.attr('src',baseImg+'&key='+mapk);
            });
        }
    })
    .always(function(){});
